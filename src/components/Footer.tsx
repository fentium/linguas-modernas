      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col space-y-4">
            ...
            <p className="mt-4">
              Transformando vidas através do ensino de idiomas há mais de 15 anos.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>Av. Rio Branco, 156 - Centro, Rio de Janeiro - RJ, 20040-003</span>
              </li>
              <li className="flex items-center">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="mr-2 flex-shrink-0">
              ...
              <li className="flex items-center">
                ...
                <span>contato@linguasmodernas.com.br</span>
              </li>
            </ul>
            
            <div className="flex space-x-4 mt-4">
              <a href="#" className="hover:text-lm-yellow transition" aria-label="Facebook">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
              </a>
              <a href="#" className="hover:text-lm-yellow transition" aria-label="Instagram">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
              ...
              <a href="#" className="hover:text-lm-yellow transition" aria-label="LinkedIn">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
